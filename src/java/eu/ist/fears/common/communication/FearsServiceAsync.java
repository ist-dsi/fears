...
public interface FearsServiceAsync {
    ...
    public void addComment(String projectName, String featureName, String comment, State newState, String sessionID,
    ...
    public void getVoter(String _projectid, String userOID, String cookie, AsyncCallback<List<ViewVoterDetailed>> callback);

    public void getCurrentVoter(String _projectid, String cookie, AsyncCallback callback);

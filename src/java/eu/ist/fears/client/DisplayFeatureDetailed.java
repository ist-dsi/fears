...
public class DisplayFeatureDetailed extends Composite {
	...
	public DisplayFeatureDetailed(String projectName, String featureName){

		_projectName = projectName;
		_featureName = featureName;
		Fears.setPath(projectName, "Sugest&atilde;o", true);
	...
	protected void update(){
		_com.getFeature(_projectName, _featureName, Cookies.getCookie("fears"), new FeatureCB(this));
	}
